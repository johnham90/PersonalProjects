package ca.bcit.comp1510.lab2; // new line?
...
public class BaseConvert {
    ...
    public static void main(String[] args) {
        ...
        int quotient = base10number / base;
        ...
        baseBNumber =  baseBNumber + place3 + place2 + place1 + place0;
        
        System.out.println(base10number + " in base " + base + " is " 
                + baseBNumber);
